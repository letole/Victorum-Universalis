...
NCountry = {
	...
	GREAT_PROJECT_DEGRADATION_PERCENT_THRESHOLD_FOR_TIER_1 = 15, --state of repair threshold for tier 1 benefits
	GREAT_PROJECT_DEGRADATION_PERCENT_THRESHOLD_FOR_TIER_2 = 30, --state of repair threshold for tier 2 benefits
	GREAT_PROJECT_DEGRADATION_PERCENT_THRESHOLD_FOR_TIER_3 = 45, --state of repair threshold for tier 3 benefits
	GREAT_PROJECT_DEGRADATION_PERCENT_THRESHOLD_FOR_TIER_4 = 60, --state of repair threshold for tier 3 benefits
